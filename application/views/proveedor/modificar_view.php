<center>
    <h1>Modificar Proveedor</h1>
        <form action="" method="POST">
            ...
            <input type="text"  name="direccion" value="<?=$fila->nombre?>" class="form-control">
            <input type="text"  name="direccion" value="<?=$fila->apellido?>" class="form-control">
            <input type="text"  name="direccion" value="<?=$fila->telefono?>" class="form-control">
